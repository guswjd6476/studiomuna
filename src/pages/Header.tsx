    ...
    return (
        <>
            ...
            >
                {/* 닫기 버튼 */}
                <button
                    className="p-2 absolute top-4 right-4 lg:px-4 border-2 border-[#00C000] text-[#00C000] rounded transition duration-300 
                        hover:bg-[#00C000] hover:text-white"
                    onClick={closeMenu}
                >
                    CLOSE
                ...
                <div className="flex flex-col items-center justify-center h-full">
                    <Link
                        className="p-7 text-5xl font-bold text-gray-800 hover:text-[#00C000] transition "
                        href="/"
                        onClick={closeMenu}
                    >
                        HOME
